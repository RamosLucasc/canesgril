...
def index(request):
    ...
    return render(request, 'index.html', {'lista_pratos': pratos_por_pagina}) # Renderiza o novo index.html
...
def buscar(request):
    ...
    return render(request, 'index.html', {'lista_pratos': pratos_por_pagina, 'buscar':nome_a_buscar})  
